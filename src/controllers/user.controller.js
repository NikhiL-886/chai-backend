...
const registerUser=asyncHandler(async(req,res)=>{
     ...
     //upload them on cloudniary,avatar
...
const refreshAccessToken=asyncHandler(async(req,res)=>{
      ...
      try {
            ...
            .json(
                  new ApiResponse(200,{accessToken,refreshToken:newRefreshToken},"RefreshToken is renewed")
            )
      } catch (error) {
...
const updateAccountDetails=asyncHandler(async(req,res)=>{
      ...
      const user = await User.findByIdAndUpdate( //there is no await in the main Code
            req.user?._id,
            {
                  $set:{
                        fullName,
      ...
      .status(200)
      .json(
            new ApiResponse(200,user,"User Details are updated Successfully")
      )
})
